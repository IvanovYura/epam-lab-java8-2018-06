...
public class Exercise2 {
    ...
    public void personHasNotEmptyLastNameAndFirstName() {
        ...
        validate = person -> !person.getFirstName().isEmpty() && !person.getLastName().isEmpty();
    ...
    public void personHasNotEmptyLastNameAndFirstNameUsingLogicalOperators() {
        final Predicate<Person> personHasEmptyFirstName = person -> person.getFirstName().isEmpty();
        final Predicate<Person> personHasEmptyLastName = person -> person.getLastName().isEmpty();
